...
unsigned int nStakeTargetSpacing = 4 * 60; // 4-minute block spacing
int64 nChainStartTime = 1382065867;
...
const string strMessageMagic = "TagCoin Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in TagCoin
    bool fStrictPayToScriptHash = true; // Always active in TagCoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "TagCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Oct 17 2013 - Ed Lauter is dead";
        CTransaction txNew;
        ...
        block.nVersion = 1;
        block.nTime    = 1382065907;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 646964;
		
		if (fTestNet)
        {
            block.nTime = 1382065887;
            block.nNonce = 260533;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xe3484f0fee0370380edcb92c089dfd686937335867b073c26407ab1406499bc5"));
