...
Copyright (c) 2013 TagCoin Developers
...
Intro
-----
TagCoin is a free open source project derived from PPCoin, with
...
After completing windows setup then run windows command line (cmd)
  cd daemon
  TagCoind
You would need to create a configuration file TagCoin.conf in the default
wallet directory. Grant access to TagCoind.exe in anti-virus and firewall
...
TagCoind backupwallet <destination_backup_file>
Then shutdown ppcoind by
TagCoind stop
Start up the new TagCoind (0.3.0).
